...
export interface IERC721MetadataAbiInterface extends utils.Interface {
  functions: {
...
export interface IERC721MetadataAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: IERC721MetadataAbiInterface;
