...
export interface BaseTestAbiInterface extends utils.Interface {
  functions: {
    ...
    "testHypertents()": FunctionFragment;
  };
  ...
  encodeFunctionData(
    functionFragment: "testHypertents",
    values?: undefined
  ): string;
...
export interface BaseTestAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: BaseTestAbiInterface;
  ...
  callStatic: {
    ...
    testHypertents(overrides?: CallOverrides): Promise<void>;
  };
