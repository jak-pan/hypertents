...
import type {
  BaseIsmpModuleAbi,
  BaseIsmpModuleAbiInterface,
} from "../../IIsmpModule.sol/BaseIsmpModuleAbi";
...
export class BaseIsmpModuleAbi__factory {
  static readonly abi = _abi;
  static createInterface(): BaseIsmpModuleAbiInterface {
    return new utils.Interface(_abi) as BaseIsmpModuleAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): BaseIsmpModuleAbi {
    return new Contract(address, _abi, signerOrProvider) as BaseIsmpModuleAbi;
  }
}
