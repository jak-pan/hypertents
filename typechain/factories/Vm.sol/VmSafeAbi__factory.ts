...
import type { VmSafeAbi, VmSafeAbiInterface } from "../../Vm.sol/VmSafeAbi";
...
export class VmSafeAbi__factory {
  ...
  static createInterface(): VmSafeAbiInterface {
    return new utils.Interface(_abi) as VmSafeAbiInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): VmSafeAbi {
    return new Contract(address, _abi, signerOrProvider) as VmSafeAbi;
  }
}
