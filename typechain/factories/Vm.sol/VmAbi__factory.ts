...
import type { VmAbi, VmAbiInterface } from "../../Vm.sol/VmAbi";
...
export class VmAbi__factory {
  ...
  static createInterface(): VmAbiInterface {
    return new utils.Interface(_abi) as VmAbiInterface;
  }
  static connect(address: string, signerOrProvider: Signer | Provider): VmAbi {
    return new Contract(address, _abi, signerOrProvider) as VmAbi;
  }
}
