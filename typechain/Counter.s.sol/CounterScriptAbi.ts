...
export interface CounterScriptAbiInterface extends utils.Interface {
  functions: {
...
export interface CounterScriptAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: CounterScriptAbiInterface;
