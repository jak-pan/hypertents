...
export interface ITokenFaucetAbiInterface extends utils.Interface {
  functions: {
...
export interface ITokenFaucetAbi extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: ITokenFaucetAbiInterface;
